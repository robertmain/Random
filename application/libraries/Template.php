...
class CI_Template {
    ...
    var $breadcrumbs = array('separator' => ' &raquo; ');
    ...
    /**
     * creates the links at the top of the page
     * @param type $title
     * @param type $uri
     */
    function set_breadcrumb($title, $uri = FALSE) {
        $this->breadcrumbs['breadcrumbs'][] = array('title' => $title, 'uri' => $uri);
    }
    ...
    function get_breadcrumb() {
        ...
        if (!isset($this->breadcrumbs['breadcrumbs'])) {

            $this->write('breadcrumbs', '');
        }
        else {
            $breadcrumbs_view = $this->CI->load->view('desktop/components/breadcrumbs', $this->breadcrumbs, TRUE);
            $this->write('breadcrumbs', $breadcrumbs_view);
        }
    }
